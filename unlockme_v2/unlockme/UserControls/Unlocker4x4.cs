...
namespace unlockme
{
    public partial class Unlocker4x4 : UserControl, IUnlocker
    {
        ...
        public Unlocker4x4()
        {
            ...
            panelList.Add(field_0x3);
            panelList.Add(field_1x0);
            panelList.Add(field_1x1);
            panelList.Add(field_1x2);
            panelList.Add(field_1x3);
            panelList.Add(field_2x0);
            panelList.Add(field_2x1);
            panelList.Add(field_2x2);
            panelList.Add(field_2x3);
            panelList.Add(field_3x0);
            panelList.Add(field_3x1);
            panelList.Add(field_3x2);
            panelList.Add(field_3x3);
        ...
        private void Check_Click(object sender, EventArgs e) => CheckPattern4x4?.Invoke(this);
